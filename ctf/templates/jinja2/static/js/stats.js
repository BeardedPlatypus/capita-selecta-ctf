...
Elm.Team = Elm.Team || {};
Elm.Team.make = function (_elm) {
   "use strict";
   _elm.Team = _elm.Team || {};
   if (_elm.Team.values) return _elm.Team.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var iconUrl = "http://i.imgur.com/vqtnJqI.png";
   var toHexColour = function (team) {
      var _p0 = team;
      if (_p0.ctor === "Red") {
            return "#f84545";
         } else {
   ...
   var Blue = {ctor: "Blue"};
   var Red = {ctor: "Red"};
   return _elm.Team.values = {_op: _op
                             ,toStr: toStr
...
Elm.StatsPanel = Elm.StatsPanel || {};
Elm.StatsPanel.make = function (_elm) {
   "use strict";
   _elm.StatsPanel = _elm.StatsPanel || {};
   if (_elm.StatsPanel.values) return _elm.StatsPanel.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Team = Elm.Team.make(_elm);
   var _op = {};
   var viewPlayerStats = function (model) {
      var inner_class_2 = $Html.div(_U.list([$Html$Attributes.$class("col-md-4")]));
      var int_value = function (i) {
         return inner_class_2(_U.list([$Html.text($Basics.toString(i))]));
      };
      var inner_class_4 = $Html.div(_U.list([$Html$Attributes.$class("col-md-8")]));
      var outer_row = $Html.div(_U.list([$Html$Attributes.$class("row")]));
      var player_name = outer_row(_U.list([inner_class_4(_U.list([$Html.text("Player name:")]))
                                          ,inner_class_2(_U.list([$Html.text(model.player_name)]))]));
      var player_score = outer_row(_U.list([inner_class_4(_U.list([$Html.text("Score:")]))
                                           ,int_value(model.score)]));
      var player_kills = outer_row(_U.list([inner_class_4(_U.list([$Html.text("Kills:")]))
                                           ,int_value(model.kills)]));
      var player_deaths = outer_row(_U.list([inner_class_4(_U.list([$Html.text("Deaths:")]))
                                            ,int_value(model.deaths)]));
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("col-md-12")]),
      _U.list([player_name,player_score,player_kills,player_deaths]));
   };
   var viewTeamScores = F2(function (player_team,scores) {
      var icon_player_team = A2($Html.img,
      _U.list([$Html$Attributes.src($Team.iconUrl)
              ,$Html$Attributes.$class("ctf_team_icon")]),
      _U.list([]));
      var inner_class_2 = $Html.div(_U.list([$Html$Attributes.$class("col-md-4")]));
      var team_score = function (s) {
         return inner_class_2(_U.list([$Html.text($Basics.toString(s))]));
      };
      var inner_class_3 = $Html.div(_U.list([$Html$Attributes.$class("col-md-6")]));
      var team_name = function (t) {
         return inner_class_3(_U.list([$Html.text($Team.toStr(t))]));
      };
      var inner_class_1 = $Html.div(_U.list([$Html$Attributes.$class("col-md-2")]));
      var team_player_icon = function (t) {
         return inner_class_1(_U.eq(player_team,
         t) ? _U.list([icon_player_team]) : _U.list([]));
      };
      var class_name = function (t) {
         var _p0 = t;
         if (_p0.ctor === "Red") {
               return "row ctf_team_red_row";
            } else {
               return "row ctf_team_blue_row";
            }
      };
      var outer_row = function (t) {
         return $Html.div(_U.list([$Html$Attributes.$class(class_name(t))]));
      };
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("col-md-12")]),
      A2($List.map,
      function (t) {
         return A2(outer_row,
         $Basics.fst(t),
         _U.list([team_player_icon($Basics.fst(t))
                 ,team_name($Basics.fst(t))
                 ,team_score($Basics.snd(t))]));
      },
      scores));
   });
   var view = F2(function (address,model) {
      var outer_container = $Html.div(_U.list([$Html$Attributes.$class("col-xs-6 col-sm-6 col-md-6 col-lg-6 ctf_companent_side")]));
      return outer_container(_U.list([A2($Html.div,
                                     _U.list([$Html$Attributes.$class("row ctf_stats-teams")]),
                                     _U.list([A2(viewTeamScores,model.team,model.team_score)]))
                                     ,A2($Html.div,
                                     _U.list([$Html$Attributes.$class("row ctf_stats-values")]),
                                     _U.list([viewPlayerStats(model)]))]));
   });
   var update = F2(function (action,model) {
      ...
      {case "NoAction": return {ctor: "_Tuple2"
                               ,_0: model
                               ,_1: $Effects.none};
         case "UpdateTeamScore": var update_score = function (_p2) {
              var _p3 = _p2;
              var _p4 = _p3._0;
              return _U.eq(_p1._0,_p4) ? {ctor: "_Tuple2"
                                         ,_0: _p4
                                         ,_1: _p1._1} : {ctor: "_Tuple2",_0: _p4,_1: _p3._1};
           };
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {team_score: A2($List.map,update_score,model.team_score)})
                  ,_1: $Effects.none};
         case "UpdatePlayerName": return {ctor: "_Tuple2"
                                         ,_0: _U.update(model,{player_name: _p1._0})
                                         ,_1: $Effects.none};
         case "UpdateScore": return {ctor: "_Tuple2"
                                    ,_0: _U.update(model,{score: _p1._0})
                                    ,_1: $Effects.none};
         case "UpdateKills": return {ctor: "_Tuple2"
                                    ,_0: _U.update(model,{kills: _p1._0})
                                    ,_1: $Effects.none};
         default: return {ctor: "_Tuple2"
                         ,_0: _U.update(model,{deaths: _p1._0})
                         ,_1: $Effects.none};}
   });
   var UpdateDeaths = function (a) {
      return {ctor: "UpdateDeaths",_0: a};
   };
   var UpdateKills = function (a) {
      return {ctor: "UpdateKills",_0: a};
   };
   var UpdateScore = function (a) {
      return {ctor: "UpdateScore",_0: a};
   };
   var UpdatePlayerName = function (a) {
      return {ctor: "UpdatePlayerName",_0: a};
   };
   var UpdateTeamScore = F2(function (a,b) {
      return {ctor: "UpdateTeamScore",_0: a,_1: b};
   });
   var NoAction = {ctor: "NoAction"};
   var init = {ctor: "_Tuple2"
              ,_0: {team: $Team.Red
                   ,team_score: _U.list([{ctor: "_Tuple2",_0: $Team.Red,_1: 0}
                                        ,{ctor: "_Tuple2",_0: $Team.Blue,_1: 0}])
   ...
   return _elm.StatsPanel.values = {_op: _op
                                   ,init: init
                                   ,update: update
                                   ,view: view
                                   ,Model: Model
...
Elm.Stats.make = function (_elm) {
   ...
   if (_elm.Stats.values) return _elm.Stats.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $StatsPanel = Elm.StatsPanel.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var app = $StartApp.start({init: $StatsPanel.init
   ...
   app.tasks);
   return _elm.Stats.values = {_op: _op,app: app,main: main};
};
