...
Elm.PowerUpDefinitions = Elm.PowerUpDefinitions || {};
Elm.PowerUpDefinitions.make = function (_elm) {
   "use strict";
   _elm.PowerUpDefinitions = _elm.PowerUpDefinitions || {};
   if (_elm.PowerUpDefinitions.values)
   return _elm.PowerUpDefinitions.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var toImgUrl = function (id) {
      var _p0 = id;
      switch (_p0.ctor)
      {case "Speed": return "http://i.imgur.com/HNA2sJw.png";
         case "Invincibility": return "http://i.imgur.com/vIumg1n.png";
         case "Invisibility": return "http://i.imgur.com/SvTRr2J.png";
         default: return "http://i.imgur.com/h0Mkcyd.png";}
   };
   var toStr = function (id) {
      var _p1 = id;
      switch (_p1.ctor)
   ...
   var Bomb = {ctor: "Bomb"};
   var Invisibility = {ctor: "Invisibility"};
   var Invincibility = {ctor: "Invincibility"};
   var Speed = {ctor: "Speed"};
   return _elm.PowerUpDefinitions.values = {_op: _op
                                           ,toStr: toStr
                                           ,toImgUrl: toImgUrl
                                           ,Speed: Speed
...
Elm.PowerUpButton = Elm.PowerUpButton || {};
Elm.PowerUpButton.make = function (_elm) {
   "use strict";
   _elm.PowerUpButton = _elm.PowerUpButton || {};
   if (_elm.PowerUpButton.values) return _elm.PowerUpButton.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $PowerUpDefinitions = Elm.PowerUpDefinitions.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   ...
   var view = F2(function (address,model) {
      var img = A2($Html.img,
      _U.list([$Html$Attributes.src($PowerUpDefinitions.toImgUrl(model.id))
              ,$Html$Attributes.alt($PowerUpDefinitions.toStr(model.id))
              ,$Html$Attributes.width(100)]),
      _U.list([]));
      var attributes = _U.list([$Html$Attributes.$class("btn btn-block btn-warning btn-embossed")
                               ,A2($Html$Events.onClick,address,Click)]);
      return A2($Html.a,attributes,_U.list([img]));
   });
   var NoAction = {ctor: "NoAction"};
   var bombButton = {ctor: "_Tuple2"
                    ,_0: {id: $PowerUpDefinitions.Bomb,is_active: true}
                    ,_1: $Effects.none};
   var invisibilityButton = {ctor: "_Tuple2"
                            ,_0: {id: $PowerUpDefinitions.Invisibility,is_active: true}
                            ,_1: $Effects.none};
   var invincibilityButton = {ctor: "_Tuple2"
                             ,_0: {id: $PowerUpDefinitions.Invincibility,is_active: true}
                             ,_1: $Effects.none};
   var speedButton = {ctor: "_Tuple2"
                     ,_0: {id: $PowerUpDefinitions.Speed,is_active: true}
                     ,_1: $Effects.none};
   var Model = F2(function (a,b) {
      return {id: a,is_active: b};
   });
   return _elm.PowerUpButton.values = {_op: _op
                                      ,speedButton: speedButton
                                      ,invincibilityButton: invincibilityButton
...
Elm.PowerUpPanel = Elm.PowerUpPanel || {};
Elm.PowerUpPanel.make = function (_elm) {
   "use strict";
   _elm.PowerUpPanel = _elm.PowerUpPanel || {};
   if (_elm.PowerUpPanel.values) return _elm.PowerUpPanel.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $PowerUpButton = Elm.PowerUpButton.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var update = F2(function (action,model) {
   ...
   var toAction = F2(function (model,action) {
      var _p1 = action;
      if (_p1.ctor === "Click") {
            return ActivateButton(model);
         } else {
            return NoAction;
         }
   });
   var viewButton = F2(function (address,model) {
      return A2($PowerUpButton.view,
      A2($Signal.forwardTo,address,toAction(model)),
      model);
   });
   var view = F2(function (address,model) {
      var button_container = $Html.div(_U.list([$Html$Attributes.$class("col-xs-3 col-sm-3 col-md-3 col-lg-3")]));
   ...
   var init = {ctor: "_Tuple2"
              ,_0: _U.list([$Basics.fst($PowerUpButton.speedButton)
                           ,$Basics.fst($PowerUpButton.invincibilityButton)
                           ,$Basics.fst($PowerUpButton.invisibilityButton)
                           ,$Basics.fst($PowerUpButton.bombButton)])
              ,_1: $Effects.none};
   return _elm.PowerUpPanel.values = {_op: _op
                                     ,init: init
                                     ,update: update
                                     ,view: view};
};
Elm.PowerUp = Elm.PowerUp || {};
Elm.PowerUp.make = function (_elm) {
   "use strict";
   _elm.PowerUp = _elm.PowerUp || {};
   if (_elm.PowerUp.values) return _elm.PowerUp.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $PowerUpPanel = Elm.PowerUpPanel.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $StartApp = Elm.StartApp.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var app = $StartApp.start({init: $PowerUpPanel.init
   ...
   app.tasks);
   return _elm.PowerUp.values = {_op: _op,app: app,main: main};
};
