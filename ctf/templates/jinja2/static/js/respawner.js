...
Elm.PlayerClass = Elm.PlayerClass || {};
Elm.PlayerClass.make = function (_elm) {
   "use strict";
   _elm.PlayerClass = _elm.PlayerClass || {};
   if (_elm.PlayerClass.values) return _elm.PlayerClass.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var deathToStr = "Death";
   var deathToUrl = "http://www.mysoti.com/img/user/altoonativ/product/web/1209107/1209107_show_default.png";
   var toImgUrl = function (player_class) {
      var _p0 = player_class;
      switch (_p0.ctor)
      {case "Light": return "http://i.imgur.com/yY5f0hm.png";
         case "Medium": return "http://i.imgur.com/epotstg.png";
         default: return "http://i.imgur.com/rDVcgPk.png";}
   };
   var toStr = function (player_class) {
      var _p1 = player_class;
      switch (_p1.ctor)
      {case "Light": return "Light Class";
         case "Medium": return "Medium Class";
         default: return "Heavy Class";}
   };
   var Heavy = {ctor: "Heavy"};
   var Medium = {ctor: "Medium"};
   var Light = {ctor: "Light"};
   return _elm.PlayerClass.values = {_op: _op
                                    ,toStr: toStr
                                    ,toImgUrl: toImgUrl
                                    ,deathToUrl: deathToUrl
                                    ,deathToStr: deathToStr
                                    ,Light: Light
                                    ,Medium: Medium
                                    ,Heavy: Heavy};
};
Elm.ClassButton = Elm.ClassButton || {};
Elm.ClassButton.make = function (_elm) {
   "use strict";
   _elm.ClassButton = _elm.ClassButton || {};
   if (_elm.ClassButton.values) return _elm.ClassButton.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $PlayerClass = Elm.PlayerClass.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var update = F2(function (action,model) {
      ...
      {case "NoAction": return {ctor: "_Tuple2"
                               ,_0: model
                               ,_1: $Effects.none};
         case "Activate": return {ctor: "_Tuple2"
                                 ,_0: _U.update(model,{is_active: true})
                                 ,_1: $Effects.none};
         default: return {ctor: "_Tuple2"
                         ,_0: _U.update(model,{is_active: false})
                         ,_1: $Effects.none};}
   });
   ...
   var view = F2(function (address,model) {
      var img = A2($Html.img,
      _U.list([$Html$Attributes.src($PlayerClass.toImgUrl(model.$class))
              ,$Html$Attributes.alt($PlayerClass.toStr(model.$class))
              ,$Html$Attributes.width(100)]),
      _U.list([]));
      var elements = _U.list([img]);
      var attributes = _U.list([$Html$Attributes.$class("btn btn-block btn-danger btn-embossed")
                               ,A2($Html$Events.onClick,address,Activate)]);
      return A2($Html.a,attributes,elements);
   });
   var NoAction = {ctor: "NoAction"};
   var heavyButton = {ctor: "_Tuple2"
                     ,_0: {$class: $PlayerClass.Heavy,is_active: false}
                     ,_1: $Effects.none};
   var mediumButton = {ctor: "_Tuple2"
                      ,_0: {$class: $PlayerClass.Medium,is_active: false}
                      ,_1: $Effects.none};
   var lightButton = {ctor: "_Tuple2"
                     ,_0: {$class: $PlayerClass.Light,is_active: false}
                     ,_1: $Effects.none};
   var Model = F2(function (a,b) {
      return {$class: a,is_active: b};
   });
   return _elm.ClassButton.values = {_op: _op
                                    ,lightButton: lightButton
                                    ,mediumButton: mediumButton
                                    ,heavyButton: heavyButton
                                    ,update: update
                                    ,view: view
                                    ,Model: Model
                                    ,NoAction: NoAction
...
Elm.ClassButtonPanel = Elm.ClassButtonPanel || {};
Elm.ClassButtonPanel.make = function (_elm) {
   "use strict";
   _elm.ClassButtonPanel = _elm.ClassButtonPanel || {};
   if (_elm.ClassButtonPanel.values)
   return _elm.ClassButtonPanel.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $ClassButton = Elm.ClassButton.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "NoAction") {
            return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         } else {
            var updateButton = function (classButtonModel) {
               return _U.eq(classButtonModel.$class,
               _p0._0) ? A2($ClassButton.update,
               $ClassButton.Activate,
               classButtonModel) : A2($ClassButton.update,
               $ClassButton.Deactivate,
               classButtonModel);
            };
            var updated_buttons = $List.unzip(A2($List.map,
            updateButton,
            model));
            return {ctor: "_Tuple2"
                   ,_0: $Basics.fst(updated_buttons)
                   ,_1: $Effects.none};
         }
   });
   var ActivateButton = function (a) {
      return {ctor: "ActivateButton",_0: a};
   };
   var NoAction = {ctor: "NoAction"};
   var toAction = F2(function (model,action) {
      var _p1 = action;
      if (_p1.ctor === "Activate") {
            return ActivateButton(model.$class);
         } else {
            return NoAction;
         }
   });
   var viewButton = F2(function (address,model) {
      return A2($ClassButton.view,
      A2($Signal.forwardTo,address,toAction(model)),
      model);
   });
   var view = F2(function (address,model) {
      var attributes_container = _U.list([$Html$Attributes.$class("row")]);
      var button_container = $Html.div(_U.list([$Html$Attributes.$class("col-xs-4 col-sm-4 col-md-4 col-lg-4")]));
      var buttons = A2($List.map,
      function (b) {
         return button_container(_U.list([A2(viewButton,address,b)]));
      },
      model);
      return A2($Html.div,attributes_container,buttons);
   });
   var init = {ctor: "_Tuple2"
              ,_0: _U.list([{$class: $PlayerClass.Light,is_active: true}
                           ,{$class: $PlayerClass.Medium,is_active: false}
                           ,{$class: $PlayerClass.Heavy,is_active: false}])
              ,_1: $Effects.none};
   return _elm.ClassButtonPanel.values = {_op: _op
                                         ,init: init
                                         ,update: update
                                         ,view: view
                                         ,NoAction: NoAction
...
Elm.CurrentClass = Elm.CurrentClass || {};
Elm.CurrentClass.make = function (_elm) {
   "use strict";
   _elm.CurrentClass = _elm.CurrentClass || {};
   if (_elm.CurrentClass.values) return _elm.CurrentClass.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   var _op = {};
   var view = F2(function (address,model) {
      var alt = $Html$Attributes.alt(model.is_alive ? $PlayerClass.toStr(model.$class) : $PlayerClass.deathToStr);
      var src = $Html$Attributes.src(model.is_alive ? $PlayerClass.toImgUrl(model.$class) : $PlayerClass.deathToUrl);
      var img = A2($Html.img,
      _U.list([src,alt,$Html$Attributes.$class("ctf_class_symbol")]),
      _U.list([]));
      var elements = _U.list([img]);
      var attributes = _U.list([]);
      return A2($Html.div,attributes,elements);
   });
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "NoAction": return {ctor: "_Tuple2"
                               ,_0: model
                               ,_1: $Effects.none};
         case "RespawnAs": return {ctor: "_Tuple2"
                                  ,_0: {$class: _p0._0,is_alive: true}
                                  ,_1: $Effects.none};
         default: return {ctor: "_Tuple2"
                         ,_0: _U.update(model,{is_alive: false})
                         ,_1: $Effects.none};}
   });
   var Die = {ctor: "Die"};
   var RespawnAs = function (a) {
      return {ctor: "RespawnAs",_0: a};
   };
   var NoAction = {ctor: "NoAction"};
   var init = {ctor: "_Tuple2"
              ,_0: {$class: $PlayerClass.Medium,is_alive: true}
              ,_1: $Effects.none};
   var Model = F2(function (a,b) {
      return {$class: a,is_alive: b};
   });
   return _elm.CurrentClass.values = {_op: _op
                                     ,init: init
                                     ,update: update
                                     ,view: view
                                     ,Model: Model
...
Elm.RespawnPanel = Elm.RespawnPanel || {};
Elm.RespawnPanel.make = function (_elm) {
   "use strict";
   _elm.RespawnPanel = _elm.RespawnPanel || {};
   if (_elm.RespawnPanel.values) return _elm.RespawnPanel.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $ClassButtonPanel = Elm.ClassButtonPanel.make(_elm),
   $CurrentClass = Elm.CurrentClass.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   ...
   var update = F2(function (action,model) {
      ...
      if (_p0.ctor === "NoAction") {
            ...
            var _p1 = _p0._0;
            var new_buttons = A2($ClassButtonPanel.update,
            $ClassButtonPanel.ActivateButton(_p1),
            model.buttons);
            var new_current_class = A2($CurrentClass.update,
            $CurrentClass.RespawnAs(_p1),
            model.current_class);
            return {ctor: "_Tuple2"
                   ,_0: _U.update(model,
                   {current_class: $Basics.fst(new_current_class)
                   ,buttons: $Basics.fst(new_buttons)})
                   ,_1: $Effects.none};
         }
   });
   var ActivateButton = function (a) {
   ...
   var NoAction = {ctor: "NoAction"};
   var buttonPanelToAction = function (action) {
      var _p2 = action;
      if (_p2.ctor === "ActivateButton") {
            return ActivateButton(_p2._0);
         } else {
            return NoAction;
         }
   };
   var viewButtonPanel = F2(function (address,model) {
      return A2($ClassButtonPanel.view,
      A2($Signal.forwardTo,address,buttonPanelToAction),
      model);
   });
   var currentClassToAction = function (action) {
      var _p3 = action;
      return NoAction;
   };
   var viewCurrentClass = F2(function (address,model) {
      return A2($CurrentClass.view,
      A2($Signal.forwardTo,address,currentClassToAction),
      model);
   });
   var view = F2(function (address,model) {
      var row = $Html.div(_U.list([$Html$Attributes.$class("row")]));
      var current_class = row(_U.list([A2(viewCurrentClass,
      address,
      model.current_class)]));
      var button_panel = row(_U.list([A2(viewButtonPanel,
      address,
      model.buttons)]));
      var outer_container = $Html.div(_U.list([$Html$Attributes.$class("col-xs-6 col-sm-6 col-md-6 col-lg-6")]));
      return outer_container(_U.list([current_class,button_panel]));
   });
   var init = {ctor: "_Tuple2"
              ,_0: {current_class: $Basics.fst($CurrentClass.init)
                   ,buttons: $Basics.fst($ClassButtonPanel.init)}
              ,_1: $Effects.none};
   var Model = F2(function (a,b) {
      return {current_class: a,buttons: b};
   });
   return _elm.RespawnPanel.values = {_op: _op
                                     ,init: init
                                     ,update: update
                                     ,view: view
                                     ,Model: Model
...
Elm.Respawner = Elm.Respawner || {};
Elm.Respawner.make = function (_elm) {
   "use strict";
   _elm.Respawner = _elm.Respawner || {};
   if (_elm.Respawner.values) return _elm.Respawner.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $RespawnPanel = Elm.RespawnPanel.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $StartApp = Elm.StartApp.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var app = $StartApp.start({init: $RespawnPanel.init
   ...
   app.tasks);
   return _elm.Respawner.values = {_op: _op,app: app,main: main};
};
